...
class Settings(BaseSettings):
    ...
    INLINE_VPN_NAME: str = "VPN"
    INLINE_REFERRAL_THUMBNAIL_URL: Optional[str] = None
    INLINE_TRIAL_THUMBNAIL_URL: Optional[str] = None
    INLINE_GENVPN_THUMBNAIL_URL: Optional[str] = None
